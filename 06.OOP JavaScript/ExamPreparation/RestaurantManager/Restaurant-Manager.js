function processRestaurantManagerCommands(commands) {
    ...
    Object.prototype.validatePositiveNumber = function (value, variableName) {
        if (value < 0) {
            throw new Error(variableName + " should be positive!");
        }
    }
    ...
    var RestaurantEngine = (function () {
        ...
        var Restaurant = (function () {
            ...
            Restaurant.prototype.printRestaurantMenu = function () {
                ...
                if (this._recipes.length === 0) {
                    ...
                    return nameString + noRecipesString;
                }
                ...
                if (mainCourses.length > 0) {
                    var mainCoursesString = "~~~~~ MAIN COURSES ~~~~~\n";
                    result += mainCoursesString;
                ...
                if (desserts.length > 0) {
                    var dessertsString = "~~~~~ DESSERTS ~~~~~\n";
                    result += dessertsString;
        ...
        var Recipe = (function () {
            ...
            Recipe.prototype.setTimeToPrepare = function (timeToPrepare) {
                ...
                if (this.constructor === Drink) {
                    if (timeToPrepare > 20) {
                        throw new Error("The time to prepare must not be greater than 20 minutes");
                    }
                }
