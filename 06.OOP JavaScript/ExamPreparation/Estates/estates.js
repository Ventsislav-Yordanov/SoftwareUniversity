function processEstatesAgencyCommands(commands) {
    ...
    Object.prototype.validateIntegerRange = function (value, variableName, minValue, maxValue) {
        ...
        if (value < minValue || value > maxValue) {
            throw new Error(variableName + " should be integer in the range [" + minValue + "..." + maxValue + "]!");
        }
    }
    ...
    Object.prototype.validateNonEmptyObject = function (value, className, variableName) {
        if (! (value instanceof className)) {
            throw new Error(variableName + " should be non-empty " + className.prototype.constructor.name + "!");
        }
    }
    ...
    var Estate = (function () {
        ...
        Estate.prototype.setArea = function (area) {
            this.validateIntegerRange(area, "area", MIN_AREA, MAX_AREA);
            this._area = area;
        }
        ...
        // House: Name = houseBankya, Area = 206, Location = Bankya, Furnitured = Yes, Floors: 3
        Estate.prototype.toString = function () {
            var furitured = this.getIsFurnitured() ? "Yes" : "No";
            return this.constructor.name + ": Name = " + this.getName() +
                ", Area = " + this.getArea() +
                ", Location = " + this.getLocation() +
                ", Furnitured = " + furitured;
        }
    ...
    var BuildingEstate = (function () {
        ...
        BuildingEstate.prototype.setRooms = function (rooms) {
            this.validateIntegerRange(rooms, "rooms", MIN_ROOMS, MAX_ROOMS);
            this._rooms = rooms;
        }
    ...
    var House = (function () {
        ...
        House.prototype.setFloors = function (floors) {
            this.validateIntegerRange(floors, "floors", MIN_FLOORS, MAX_FLOORS);
            this._floors = floors;
        }
    ...
    var Garage = (function () {
        ...
        var MIN_WIDTH_HEIGH = 1;
        var MAX_WIDTH_HEIGH = 500;
        ...
        Garage.prototype.setWidth = function (width) {
            this.validateIntegerRange(width, "width", MIN_WIDTH_HEIGH, MAX_WIDTH_HEIGH);
            this._width = width;
        }

        Garage.prototype.getHeigth = function () {
            return this._height;
        }

        Garage.prototype.setHeigth = function (height) {
            this.validateIntegerRange(height, "height", MIN_WIDTH_HEIGH, MAX_WIDTH_HEIGH);
            this._height = height;
        }
    ...
    var Offer = (function () {
        ...
        var MIN_PRICE = 0;
        var MAX_PRICE = Number.MAX_VALUE;
        ...
        Offer.prototype.setPrice = function (price) {
            this.validateIntegerRange(price, "price", MIN_PRICE, MAX_PRICE);
            this._price = price;
        }
